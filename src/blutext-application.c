...
static void
blutext_application_activate (GApplication *app)
{
  GtkWindow *window;

  g_assert (BLUTEXT_IS_APPLICATION (app));
...
static void
blutext_application_class_init (BlutextApplicationClass *klass)
{
  GApplicationClass *app_class = G_APPLICATION_CLASS (klass);

  app_class->activate = blutext_application_activate;
}
    ...
    gpointer user_data)
{
  ...
  g_assert (BLUTEXT_IS_APPLICATION (self));
...
static const GActionEntry app_actions[] = {
  { "quit", blutext_application_quit_action },
  { "about", blutext_application_about_action },
};
